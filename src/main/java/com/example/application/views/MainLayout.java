...
/**
 * The main view is a top-level placeholder for other views. The entirety of this page excluding the route links in the
 * menu was auto-generated by the Vaadin framework.
 */
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    //Here, each page is added to the side-bar menu and linked to the appropriate class.
